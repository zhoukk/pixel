...
STBTT_DEF int stbtt_PackBegin(stbtt_pack_context *spc, unsigned char *pixels, int pw, int ph, int stride_in_bytes, int padding, void *alloc_context)
{
   ...
   spc->user_mallocator_context = alloc_context;
   spc->width = pw;
   spc->height = ph;
   spc->pixels = pixels;
...
STBTT_DEF void stbtt_PackEnd  (stbtt_pack_context *spc)
{
   STBTT_free(spc->nodes    , spc->user_mallocator_context);
   STBTT_free(spc->pack_info, spc->user_mallocator_context);
}
...
STBTT_DEF int stbtt_PackFontRanges(stbtt_pack_context *spc, unsigned char *fontdata, int font_index, stbtt_pack_range *ranges, int num_ranges)
{
   ...
   rects = (stbrp_rect *) STBTT_malloc(sizeof(*rects) * n, spc->user_mallocator_context);
   if (rects == NULL)
      return 0;
   ...
   STBTT_free(rects, spc->user_mallocator_context);
   return return_value;
}
