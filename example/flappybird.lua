...
local config = require "example.asset.bird_config"
...
local function gen_matrix()
  ...
  local m1 = matrix.new{x=0, y=offset1}
  m1 = m1:mul(matrix.new{sx=1,sy=scale, x=0, y=-offset2})
  local m2 = matrix.new({x=0, y=-offset1})
  m2 = m2:mul(matrix.new{sx=1, sy=scale, x=0, y=offset2})
  print("----------m1:", m1:export())
  print("----------m2:", m2:export())
end
gen_matrix()
